...
$string['categorymigrated'] = 'The category has been migrated to shared custom fields successfully';
...
$string['confirmmigratecategory'] = 'Are you sure you want to migrate this category and all associated data to shared custom fields? This action cannot be undone.<br/><br/>Once migrated, the shared category will be enabled by default.';
...
$string['migratecategory'] = 'Migrate custom field category: {$a}';
$string['migrationerror'] = 'Category migration cannot be completed';
...
$string['sharedcustomfieldalreadyexists'] = 'The following shared custom field short names already exist: {$a}.<br/><br/>To proceed with the migration, please rename or delete these fields from the shared category.';
